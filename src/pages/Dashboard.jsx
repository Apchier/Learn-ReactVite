            ...
            <>
                <div className="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
                    <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                        <Badge>
                            <Badge.Icon icon={<FaMoneyBillWave className="text-3xl" />} className={" from-blue-600 to-blue-400 text-white shadow-blue-500/40"} />
                            <Badge.Title title="Today's Money" value="$53k" />
                            <Badge.Description amount="+55%" period="than last week" />
                        </Badge>
                    </div>
                    <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                        <Badge>
                            <Badge.Icon icon={<FaUser className="text-2xl" />} className={" from-pink-600 to-pink-400 text-white shadow-blue-500/40"} />
                            <Badge.Title title="Today's Users" value="2,300" />
                            <Badge.Description amount="+3%" period="than last month" />
                        </Badge>
                    </div>
                    <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                        <Badge>
                            <Badge.Icon icon={<HiUserPlus className="text-3xl" />} className={" from-green-600 to-green-400 text-white shadow-blue-500/40"} />
                            <Badge.Title title="New Clients" value="3,462" />
                            <Badge.Description amount="-2%" period="than yesterday" />
                        </Badge>
                    </div>
                    <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                        <Badge>
                            <Badge.Icon icon={<FaSignal className="text-2xl" />} className={" from-orange-600 to-orange-400 text-white shadow-blue-500/40"} />
                            <Badge.Title title="Sales" value="$103,430" />
                            <Badge.Description amount="+5% " period="than yesterday" />
                        </Badge>
                    </div>
                </div>
